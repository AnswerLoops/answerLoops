...
Back in AnswerLoops, click **Check connection status** (or just reload the page). Once pairing has completed server-side, the card shows **Connected · space paired** and reveals the connected space id, escalation user, confidence threshold, and Automatic Deflections state.

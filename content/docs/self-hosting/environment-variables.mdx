...
| `NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY` | Only relevant when `DEPLOYMENT_MODE=cloud`. Publishable key for the embedded checkout form. Safe in client code — it can only create payment attempts. | `pk_live_...` |

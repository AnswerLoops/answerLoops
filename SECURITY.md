...
- The affected component (hosted app, a specific integration, the self-hosted Docker setup, etc.)

## What to expect

- We'll acknowledge your report within 3 business days.
- We'll investigate and let you know whether it's confirmed, and give you an estimated timeline for a fix.
- We'll notify you once a fix has shipped.
- We ask that you give us a reasonable time to fix a confirmed issue before disclosing it publicly.

...
Point your own SendGrid, Mailgun, Postmark, or Cloudflare account at AnswerLoops's webhook with a shared secret.
...
The inbound webhook secret is generated automatically and stored in the database per org — no env var needed for that.

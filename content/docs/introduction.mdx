...
description: "Support that lives in your community: AnswerLoops answers repeat questions right in the channel — Discord, Slack, forums, GitHub, Telegram, email, and website chat — and only when it's confident enough to be right. Open source and self-hostable."
---
...
| Multi-channel ingest | Discord (text + forum channels), Slack, GitHub Issues & Discussions, Telegram, Email, website widget — plus Discourse and Circle forums (planned) and Google Chat |
...
| Discourse | _Planned_ — REST API + webhook | Topics and posts in watched categories |
| Circle | _Planned_ — API token | Space posts and comments |
